    ...
    mainPanel(
      tabsetPanel(
        ...
        tabPanel("About",
                 ...
                 p("Reading books in a foreign language is one of the most popular methods of learning. 
                   This site aims to help leaners find the books that fit their English level."),
                 p("Partially inspired by ", 
                   a(href="https://blog.vocapouch.com/do-20-pages-of-a-book-gives-you-90-of-its-words-795a405afe70",
                     "this article, "), 
                 ...
                 p("The books have been pre-processed to get a list of 480 books from top 100 PG authors. 
                   Using the treetagger software and several R packages, I calculated the ", 
                   a(href="https://en.wikipedia.org/wiki/Flesch%E2%80%93Kincaid_readability_tests", 
                     "Flesch-Kincaid readability scores, "),
                   "as they can be ", 
                   a(href="https://linguapress.com/teachers/flesch-kincaid.htm",
                     "translated into EFL proficiency levels pretty easily."), 
                   "However, all the graphs are rendered on the go. 
                   It is possible for the user to feed the graphs their own data, 
                   as long as the file contains the mandatory information."),
                 h3("Limitations"),
